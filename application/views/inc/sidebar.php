  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="<?php echo base_url().'kelolauser'?>"><i class="fa  fa-users"></i> <span>Kelola Data User</span></a></li>
      <li><a href="<?php echo base_url().'kelolapoin'?>"><i class="fa fa-rocket"></i> <span>Kelola Poin</span></a></li>
      <li><a href="<?php echo base_url().'kelolaaktivitas'?>"><i class="fa fa-list-ul"></i> <span>Kelola Aktivitas</span></a></li>
      <li><a href="<?php echo base_url().'kelolaakun'?>"><i class="fa fa-user"></i> <span>Kelola Akun</span></a></li>
