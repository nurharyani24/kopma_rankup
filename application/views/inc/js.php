...
<!-- AJAX -->
 <script src="<?php echo base_url('assets/JqueryAjax/jquery-3.3.1.min.js') ?>"></script>
<!-- jQuery 3 -->
...
<!-- Bootstrap 3.3.7 -->
<script type="text/javascript" src="<?php echo base_url('assets/AdminLTE-2.4.0/bower_components/bootstrap/dist/js/bootstrap.min.js') ?>"></script>
<!-- Morris.js charts -->
