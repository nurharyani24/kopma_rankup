            ...
            <?php 
              ...
              echo "<tr>
                    ...
                    <td><center>
                      ...
                      <a class='btn btn-fill btn-danger btn-xs' data-toggle='tooltip' data-placement='bottom' title='Hapus' href='".base_url()."kelolauser/hapus/$row[id_du]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='fa fa-trash-o'></span></a>
                    </tr>";
                $no++;
              }
            ?>
