...
<!-- Content Header (Page header) -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Aktivitas</li>
      </ol>
    </section>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title"><b>Tambah Aktivitas</b></h3>
            
          </div>
          <!-- /.box-header -->
          <div class="box-body">
          <!-- form start -->
          <form class="form-horizontal" action="<?php echo site_url('kelolaaktivitas/tambah') ?>" method="post">
          <div class="box-body">
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">Nama Aktivitas</label>
    
              <div class="col-sm-9">
                <input type="text" class="form-control" id="activity_name" placeholder="Nama Aktivitas" name="activity_name">
              </div>
            </div>
