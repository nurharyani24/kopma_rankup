            ...
            <?php 
              ...
              echo "<tr>
                    ...
                    <td><center>
                      ...
                      <a class='btn btn-fill btn-danger btn-xs' data-toggle='tooltip' data-placement='bottom' title='Hapus' href='".base_url()."kelolaaktivitas/hapus/$row[id_activity]'><span class='fa fa-trash-o'></span></a>
                    </tr>";
                $no++;
              }
            ?>
